...
<%@include file="CommonHeader.jsp" %>
		...
		<section style="padding:5% 15%;">
			<h5>Thank you ${username} for shopping with us!!!!</h5>
			<p>Your order is placed successfully. Please keep the required cash ready whenever the product will get delivered at your <strong>Registered Address</strong> within 15 days from the date of placing the order.</p><br><br><br>
